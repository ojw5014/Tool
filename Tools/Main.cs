...
namespace Tools
{
    public partial class Main : Form
    {
        ...
        private void btnKeyboard_Global_Click(object sender, EventArgs e)
        {
            Ojw.CTools_Keyboard CTool_Keyboard = new Ojw.CTools_Keyboard();
            //CTool_Keyboard.ShowKeyboard();
            CTool_Keyboard.SetOpacity(1.0);
            CTool_Keyboard.EnableKorean(false);
            CTool_Keyboard.ShowKeyboard(0, 0);
            //if (Ojw.CSystem.IsScreenKeyboard2() == true)
            //{
            //    //Ojw.CSystem.Kill_ScreenKeyboard2();
            //    Ojw.CSystem.ScreenKeyboard2(true);
            //}
            //else
            //{
            //    Ojw.CSystem.Kill_ScreenKeyboard2();
